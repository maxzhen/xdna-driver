...
enum amdxdna_drm_config_hwctx_param {
	...
	DRM_AMDXDNA_HWCTX_CONFIG_AUTO_COREDUMP = 4,
};
...
enum amdxdna_drm_set_param {
	...
	DRM_AMDXDNA_SET_FORCE_PREEMPT = 3,
	DRM_AMDXDNA_SET_FRAME_BOUNDARY_PREEMPT = 4,
	DRM_AMDXDNA_SET_FW_LOG_STATE = 5,
...
struct amdxdna_drm_set_state {
	 ...
	 * DRM_ROOT_ONLY).
	 *
	 * %DRM_AMDXDNA_SET_HWCTX_RESET:
	 * Sets hardware context reset state.
	 * 0 - no auto-reset after timeout.
	 * 1 - auto-reset after timeout to recover.
	 */
	__u32 param;
	/**
	 * @buffer_size:
